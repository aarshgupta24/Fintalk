    ...
    tickers.forEach(function (ticker){
        $.ajax({
            ...
            success: function(data){
                ...
                $(`#${ticker}-price`).removeClass('dark-red red gray green dark-green').addClass();
                $(`#${ticker}-pct`).removeClass('dark-red red gray green dark-green').addClass();
